			...
			<div class="javo-rotate-front-bottom">
				...
				<?php if ($javo_custom_item_tab->get('ratings', '') == ''): ?>
					<div class="javo_archive_list_rating"
					     data-score="<?php echo (int)$javo_meta_query->_get('rating_average'); ?>"></div>
				<?php endif; ?>
			</div>
			<!-- javo-rotate-front-bottom -->
		</div>
		<!-- javo-rotate-front -->
				...
				<div class="col-md-12">
					...
					<a href="<?php the_permalink(); ?>">
						...
						<span class="javo-sns-wrap social-wrap">
							...
							<i class="sns-heart">
								<a class="javo-tooltip favorite javo_favorite<?php echo $javo_favorite->on(get_the_ID(), ' saved'); ?>"
								   data-post-id="<?php the_ID(); ?>"
								   title="<?php _e('Add My Favorite', 'javo_fr'); ?>"></a>
							</i>
						</span>
