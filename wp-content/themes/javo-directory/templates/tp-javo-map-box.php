		...
		<div class="thumbnail item-list-box-map">
			<div class="thumb-wrap">
				...
				<div class="three-inner-button">
					<a class="javo-hmap-marker-trigger three-inner-move" data-id="mid_{post_id}" data-post-id="{post_id}"><?php echo 'На карті' ?></a>
					<a href="{permalink}" class="three-inner-detail"><?php echo 'Детальніше' ?></a>
				...
				obj.el.gmap3({
					getgeoloc:{
						callback:function(latlng){
							if( !latlng ){
								$.javo_msg({content:'Ваша позиція не знайдена.'});
								return false;
							};
