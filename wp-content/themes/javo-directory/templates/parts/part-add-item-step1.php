			...
			<div class="row">
				<div class="col-md-8 col-sm-12 form-left">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="input-group">
								<span class="input-group-addon"><?php echo 'web-сайт'; ?></span>
					...
					<div class="line-title-bigdots">
						<h2><span><?php echo 'Головне зображення'; ?></span></h2>
					</div>
					...
					<div class="form-group">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
									<a class="btn btn-primary btn-sm javo-fileupload" data-title="<?php _e('Upload Featured Image', 'javo_fr');?>" data-input="input[name='javo_featured_url']" data-preview=".javo-this-item-featured"><?php _e('Upload Featured Image', 'javo_fr'); ?></a>
								</div><!-- col-md-12 -->
							</div><!-- row -->
							<div class="row">
								<div class="col-md-12">
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
									...
									<a class="btn btn-primary btn-sm javo-fileupload" data-multiple="true" data-title="<?php _e("Detail Images", "javo_fr"); ?>" data-preview=".javo_dim_field" data-limit="<?php echo $limit;?>"><?php _e("Detail Images", "javo_fr"); ?></a>
