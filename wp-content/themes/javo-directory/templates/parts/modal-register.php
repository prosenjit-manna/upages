					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="" for="reg-username"><?php _e('Логін', 'javo_fr');?></label>
								<input type="text" id="reg-username" name="user_login" class="form-control" required="" placeholder="<?php _e('Логін', 'javo_fr');?>">
							</div>
						</div><!-- /.col-md-6 -->
						<div class="col-md-6">
							<div class="form-group">
