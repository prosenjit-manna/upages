...
class javo_Contact_Us extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		printf('<p class="contact_us_detail"><a href="%s"><img src="%s" data-at2x="%s"></a></p>'
			, get_site_url()
			, ($javo_tso->get('bottom_logo_url') != "" ?  $javo_tso->get('bottom_logo_url') : JAVO_IMG_DIR."/upages_logo_white_footer.png")
