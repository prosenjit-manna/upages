							...
							<div class="thumbnail item-list-box-map">
								<div class="thumb-wrap">
										...
										<div class="three-inner-button">
											<a class="javo-hmap-marker-trigger three-inner-move" data-id="<?php echo 'mid_'.get_the_ID();?>" data-post-id="<?php the_ID();?>"><?php _e('На карті', 'javo_fr');?></a>
											<a href="<?php the_permalink(); ?>" class="three-inner-detail"><?php _e('Детальніше', 'javo_fr');?></a>
