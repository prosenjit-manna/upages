...
/* Listing */{
	...
	if(
		...
		$javo_db_sidemenus['listing'][] = Array(
			...
			, 'icon'		=> 'glyphicon glyphicon-pencil'
			, 'label'		=> sprintf( __('Опублікувати подію', 'javo_fr'), $javo_custom_item_label->get( 'event', __( 'Event', 'javo_fr' ) ) )
		);
	}
	...
	if(
		...
		$javo_db_sidemenus['listing'][] = Array(
			...
			, 'icon'		=> 'glyphicon glyphicon-cog'
			, 'label'		=> sprintf( __('Мій список подій', 'javo_fr'), $javo_custom_item_label->get( 'events', __( 'Events', 'javo_fr' ) ) )
		);
	}
}
