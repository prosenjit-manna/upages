		...
		<div class="javo-output padding-top-10 javo-archive-list-wrap">
			<h1 class="page-header margin-top-12">
				...
				elseif ( is_year() ) :
					...
					<?php printf('%s <small>%s</small>', $javo_this_terms_object->name, __('Archive', 'javo_fr')); ?>
					<i>
										...
										<div class="sub-cat-wraps-wrap">
											<div class="sub-cat-wraps">
												<a href="<?php echo get_term_link($term);?>">
													<h4 class="category-title"><?php echo $term->name;?><br><small><?php printf('%s %s', __('in', 'javo_fr'), $javo_this_terms_object->name);?></small></h3>
													<blockquote>
