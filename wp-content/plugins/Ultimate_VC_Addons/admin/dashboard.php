  	...
  	<p class="ultimate_updater_text">
		<?php 
			...
			if($ultimate_step == 2 || $ultimate_step == 3) :
				echo __('Thank you for choosing Brainstorm Force. You are awesome!');
			else :
				echo __('Thank you for choosing Brainstorm Force. Please take a moment to register yourself as doing so will allow us to provide you support & lifetime updates. We look forward to having you as a part of our community and serve your web design needs.');
			endif;
		?>
	</p>
          ...
          <div id="plugin_activation" class="postbox ">
          	<?php
				if($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['REMOTE_ADDR'] == '127.0.0.1' || $_SERVER['REMOTE_ADDR'] == '::1')
				{
					...
					<h2><?php echo __('Looks like you are working on local setup. <br/> Don\'t worry about registering your purchase & license.'); ?></h2>
					</div>
					<?php
				}
            ...
            <h3 class="hndle">
                ...
                <?php
					if($ultimate_step == 2)
						$title = __('Signup For Support');
					else if($ultimate_step == 3)
						$title = __('Manage Registration and Support');
					else
						$title = __('Register Your License');
				?>
            ...
            <div class="inside">
            	<div class="main" style="text-align: center;">
            		<ul class="sidebar-link-list">
						...
						<li><a href="https://www.youtube.com/user/TheBrainstormForce/videos" target="_blank" class="bsf-sidebar-link">Video Tutorials & Documentation</a></li>
						<li><a href="http://brainstormforce.com/support" target="_blank" class="bsf-sidebar-link">Request Support</a></li>
					</ul>
