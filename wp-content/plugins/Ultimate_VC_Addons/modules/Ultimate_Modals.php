...
if(!class_exists('Ultimate_Modals'))
{
	class Ultimate_Modals
	{
		...
		function register_modal_assets()
		{
			...
			//wp_register_script("ultimate-classie",plugins_url("../assets/min-js/classie.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
			//wp_register_script("ultimate-snap-svg",plugins_url("../assets/min-js/snap.svg.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
			//wp_register_script("ultimate-frongloop",plugins_url("../assets/min-js/froogaloop2.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
			//wp_register_script("ultimate-modal",plugins_url("../assets/min-js/modal.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
					...
					array(
						...
						"params" => array(
							...
							array(
								...
								"param_name" => "content",
								"value" => "",
								"description" => __("Content that will be displayed in Modal Popup.", "smile")
							),
							array(
								"type" => "dropdown",
								"class" => "",
							...
							array(
								...
								"description" => __("When should the popup be initiated?", "smile")
							),
							array(
								"type"=>"number",
								"class"=>'',
							...
							array(
								...
								"param_name" => "el_class",
								"value" => "",
								"description" => __("Add extra class name that will be applied to the modal popup, and you can use this class for your customizations.", "smile"),
							),
							array(
								"type" => "heading",
